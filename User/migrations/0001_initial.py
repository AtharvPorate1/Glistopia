    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeOfUser', models.CharField(choices=[('s', 'student'), ('m', 'food provider'), ('h', 'housing provider')], max_length=1)),
                ('username', models.CharField(blank=True, max_length=191, unique=True)),
                ('mobile', models.IntegerField(blank=True)),
                ('UserId', models.AutoField(primary_key=True, serialize=False)),
                ('profilePic', models.ImageField(upload_to='uploads/User/<django.db.models.fields.AutoField>')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('subscribedTo', models.ManyToManyField(to='Mess.subscription')),
